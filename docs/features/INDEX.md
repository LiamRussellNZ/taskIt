...
| Task pagination | Users select 25, 50, or 75 tasks per page on every task board. | `TaskRepository.java`, `TaskService.java`, `TaskController.java`, `frontend/src/App.tsx` |
